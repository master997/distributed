...
| Op | N=1000 avg | % of total |
|----|------------|-----------|
| op1 (transpose) | 1.36 ms | 2.3% |
| op2 (zone_sum) | 0.91 ms | 1.6% |
| **op3 (matmul)** | **55.81 ms** | **96.1%** |
| total | 58.08 ms | |

Conclusion: matmul dominates. Any further optimisation effort must target op3.
